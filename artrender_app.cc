...
void ArtRenderApp::InitOpenGL() {
    ...
    surface_texture_.InitFromFile(Platform::FindFile("monalisa.png", search_path_));
}
...
void ArtRenderApp::DrawUsingOpenGL() {
    ...
    if (shader_style_ == 0) {
        ...
        // Render the current model's mesh using the Grouaud shader program
        ...
        gouraud_shaderprog_.BindTexture("surface_texture", surface_texture_);
